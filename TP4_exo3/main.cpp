...
int main()
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER, vbos[1]);
        Vertex2DColor vertices[] = { 
            Vertex2DColor{{-0.5f, -0.5f}, {1./3.f, 0.f, 0.f}}, // Premier sommet
            Vertex2DColor{{ 0.5f, -0.5f}, {0.f, 1.f, 0.f}}, // Deuxième sommet
            Vertex2DColor{{ 0.0f,  0.5f}, {0.f, 0.f, 1.5f}}  // Troisième sommet
        };
    ...
    glBindVertexArray(vaos[2]);
        ...
        static constexpr GLuint vertex_attr_couleur = 1;
